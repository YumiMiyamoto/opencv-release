...
$console->log($images->matchTemplates("/sdcard/M8Test/opencv/super_mario.jpg", "/sdcard/M8Test/opencv/mario.png", null, null, function ($it) {
    $it->set(0, 0, 500, 250);
}, "/sdcard/M8Test/opencv/result_template_mario.jpg", null, null));
$console->log($images->matchTemplates("/sdcard/M8Test/opencv/super_mario.jpg", "/sdcard/M8Test/opencv/block.png", null, null, function ($it) {
