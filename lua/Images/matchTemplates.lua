...
_console:log(_images:matchTemplates("/sdcard/M8Test/opencv/super_mario.jpg", "/sdcard/M8Test/opencv/mario.png", 90, 100, nil, "/sdcard/M8Test/opencv/result_template_mario.jpg", 5, false))
_console:log(_images:matchTemplates("/sdcard/M8Test/opencv/super_mario.jpg", "/sdcard/M8Test/opencv/block.png", 90, 100, function(it)
    it:set(220, 129, 240, 150)
end, "/sdcard/M8Test/opencv/result_template_block.jpg", 5, false))
