...
$console.log($images.matchTemplates("/sdcard/M8Test/opencv/super_mario.jpg", "/sdcard/M8Test/opencv/mario.png", nil, nil, nil, "/sdcard/M8Test/opencv/result_template_mario.jpg", nil, nil))
$console.log($images.matchTemplates("/sdcard/M8Test/opencv/super_mario.jpg", "/sdcard/M8Test/opencv/block.png", nil, nil, lambda { |it| it.set(220, 129, 240, 150) }, "/sdcard/M8Test/opencv/result_template_block.jpg", nil, nil))
