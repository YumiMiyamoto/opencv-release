...
//#FF111318
$console->log($images->compareColorsInScreen("FF111318", 250, 125, null, function ($it) {
    $it->set(0, 0, 500, 250);
}, "100|25|FF111318,50|-25|FF111318|90", null, null));
$console->log($images->compareColorsInScreen("FF111318", 250, 125, null, function ($it) {
    $it->set(0, 0, 500, 250);
}, "100|25|FF111318,50|-25|FFE01318|90", null, null));
