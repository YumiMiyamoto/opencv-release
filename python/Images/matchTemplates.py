...
_console.log(
    _images.matchTemplates("/sdcard/M8Test/opencv/super_mario.jpg", "/sdcard/M8Test/opencv/mario.png", None, None, None,
                           "/sdcard/M8Test/opencv/result_template_mario.jpg", None, None))
_console.log(
    _images.matchTemplates("/sdcard/M8Test/opencv/super_mario.jpg", "/sdcard/M8Test/opencv/block.png", None, None,
                           lambda it: it.set(220, 129, 240, 150), "/sdcard/M8Test/opencv/result_template_block.jpg",
                           None, None))
