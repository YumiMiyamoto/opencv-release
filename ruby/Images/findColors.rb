 ...
 */
=end
# fun findColors(imagePath: String, firstColor: String, similarity: Int?, limit: Int?, regionBuilder: (Rect.() -> Unit)?, colors: String?, algorithm: String?, direction: Int?, ignoreAlpha: Boolean?): Results<CoordinateResult
$console.log($images.findColors("/sdcard/M8Test/opencv/super_mario.jpg", "a1adff", 100, nil, lambda { |it| it.set(200, 90, 360, 160) }, "100|25|a1adff|100,50|-25|f6ddc9|100", nil, nil, nil))