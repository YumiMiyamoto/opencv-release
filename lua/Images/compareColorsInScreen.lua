 ...
 *
 * 如果 [colors] 为 nil 或空，则仅比较指定坐标 (x, y) 的颜色是否与 [firstColor] 匹配。
...
--#FF111318
_console:log(_images:compareColorsInScreen("FF111318", 250, 125, 100, nil, "100|25|FF111318,50|-25|FF111318|90", nil, true))
_console:log(_images:compareColorsInScreen("FF111318", 250, 125, 100, nil, "100|25|FF111318,50|-25|FFE01318|90", nil, true))
